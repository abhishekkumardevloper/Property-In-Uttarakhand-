      ...
      >
        <div className="container-custom flex items-center justify-between h-full">
          ...
          <Link href="/" className="flex flex-col leading-none" data-cursor="Home">
            <span
              className="font-heading text-2xl font-light tracking-wider text-ivory"
              style={{ fontFamily: "var(--font-cormorant)" }}
            >
              HIMALAYAN
            </span>
            <span
              className="text-[9px] tracking-[0.35em] uppercase text-gold font-light"
